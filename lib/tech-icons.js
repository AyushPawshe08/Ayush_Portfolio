...
import { Webhook, TrendingUp, Network, Sliders } from "lucide-react";
...
export const TECH = {
  ...
  lightgbm: { label: "LightGBM", icon: TrendingUp, color: "#0284C7" },
  xgboost: { label: "XGBoost", icon: Network, color: "#F05A28" },
  shap: { label: "SHAP", icon: Sliders, color: "#8B5CF6" },
