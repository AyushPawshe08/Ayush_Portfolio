export const projects = [
  ...
  },
  {
    ...
    description:
      "Explainable credit risk underwriting system using LightGBM, SHAP, FastAPI, and Flask to predict loan default risk and generate rejection reason candidates.",
    cardIcons: ["lightgbm", "shap", "fastapi", "flask"],
    cover: {
      type: "image",
      image: "/projects/CreditCardUI.png",
      heading: "Credit Risk Underwriting",
      subheading: "End-to-end loan default prediction with explainability.",
    },
    liveUrl:
      "https://github.com/AyushPawshe08/Credit-Risk-Underwriting-ML-System",
    sourceUrl:
      "https://github.com/AyushPawshe08/Credit-Risk-Underwriting-ML-System",
    about: [
      "End-to-end machine learning system for predicting loan default risk on a 32K+ Kaggle credit risk dataset, with comprehensive data cleaning, outlier treatment, and financial feature engineering.",
      "Benchmarked Logistic Regression, Random Forest, XGBoost, and LightGBM using imbalanced-classification metrics (PR-AUC, ROC-AUC, Precision, Recall, F1), achieving best performance with LightGBM: PR-AUC 0.9039 and ROC-AUC 0.9485.",
      "Integrated SHAP explainability to generate model-based rejection reason candidates for high-risk applicants, deployed via FastAPI backend endpoints and an interactive Flask loan-underwriting dashboard.",
    ],
    stack: [
      "python",
      "pandas",
